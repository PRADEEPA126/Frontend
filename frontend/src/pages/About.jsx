                ...
                <div>
                    <div className='aboutOpt'>
                        ...
                        <div>
                            ...
                            <p>
                                We know exactly what volunteers, foundations and Wayanad children need. We accept applications through our e-platform.
                            </p>
                        </div>
                    </div>
                    <div className='aboutOpt'>
                    ...
                    <div className='aboutOpt'>
                        ...
                        <div>
                            <h1>SUPPORT OF WAYANAD ECONOMY</h1>
                            <p>
                                Firstly, we buy goods from Wayanad companies and brands. Only if something is not available in Ukraine, we start looking for it abroad.
                            </p>
                        </div>
                    </div>
                    <div className='aboutOpt'>
