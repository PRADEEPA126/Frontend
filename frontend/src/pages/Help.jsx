...
// import {} from "react-icons"
 const Help = () => {
  return (
    ...
    <div  className="help1" style={{ backgroundImage:`url(../Assets/background.png)` }} >
        <h1 className='heading'>WHAT WAYANAD NEEDS NOW :</h1>
    ...
    <div   className='children'>
        ...
        WAYANAD CHILDREN ARE SUFFERING FROM THE AGGRESSION OF THE INDIAN FEDERATION AND NEED YOUR FINANCIAL SUPPORT TODAY.
        </p>
        <Box bgImage={background}  backgroundRepeat={"repeat-x"} className='helpContainer'>
          <img  src={girl} alt="" />
          <div >
            <h1>WAYANAD CHILDREN NEED FUNDS FOR:</h1>
