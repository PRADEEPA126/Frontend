...
<div>
    ...
    <div className='founders'>
        ...
        <h1>WE ARE A CHARITAABLE INITIATIVE OF ORGANIZATIONS FROM KOCHI</h1>
        <div className='options'>
        <FaStarOfLife/>
        <h1>Kerala Charitable Fund Wayanad Educational Foundation</h1>
        </div>
        <div className='options'>
        <FaStarOfLife/>
        ...
        We have created a mobile donation channel for users from around the world with guaranteed targeted delivery of humanitarian goods based on the real needs of WAYANAD to help people preserve their country and peace in your homes around the world.
        </div>
        <div className='partners-row'>
            ...
            <div>
                <img src={img02} alt="" />
                <h1>Lincy Das</h1>
                <h3>Kerala Charitable Fund Wayanad Educational Foundation</h3>
            </div>
            <div>
                <img src={img03} alt="" />
                <h1>Shivashankar R</h1>
                <h3>Kerala Charitable Fund Wayanad Educational Foundation</h3>
            </div>
            <div>
                <img src={img04} alt="" />
