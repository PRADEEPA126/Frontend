            ...
            <Flex gap={'50px'} p={'20px'} direction={{ base: 'column', sm: 'column', md: 'column', lg: 'row', xl: 'row', '2xl': 'row' }} className='mainContainer' bgImage={background}>
                ...
                <Box p={'20px'} m={'auto'} w={{ base: '95%', sm: '95%', md: '75%', lg: '45%', xl: '45%', '2xl': '45%' }}>
                    ...
                    <div className='donation-container'>
                        <button onClick={() => handleAmountClick(5)}>100 RS</button>
                        <button onClick={() => handleAmountClick(25)}>500 RS</button>
                        <button onClick={() => handleAmountClick(50)}>1000 RS</button>
                        {showMore && (
                            <>
                                <button onClick={() => handleAmountClick(100)}>10000 RS</button>
                                <button onClick={() => handleAmountClick(200)}>20000 RS</button>
                                <button onClick={() => handleAmountClick(500)}>50000 RS</button>
                                <button onClick={() => handleAmountClick(1000)}>100000 RS</button>
                            </>
                        )}
                    ...
                    <Box m={'20px 0'} color={'white'} fontWeight={'bold'} fontSize={{base : '25px', sm : '25px', md : '25px', lg : '50px', xl : '50px', '2xl' : '50px'}}>
                        <h1>SAVE</h1>
                        <h1>THE WORLD</h1>
                        <h1>TOMORROW</h1>
                    </Box>
